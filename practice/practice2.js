...
//для массива, чтобы получить последний элемент метод POP(), SlICE(), длина массива
...
//2 
// let lastElem2 = array.pop();     //Метод pop() извлекает/удаляет последний элемент массива и возвращает его. Этот метод изменяет длину массива.
 // console.log(lastElem2);


//3 Если вы не хотите изменять массив, то используйте метод slice().
